...
from old import ClusteringAnalysisMethodTestingTemplate
...
async def main_func():
    ...
    await ClusteringAnalysisMethodTestingTemplate.execute(clustered_column=property_to_cluster,
                                                          show_contour_clustered=show_contour_clustered,
                                                          show_contour_raw=show_contour_raw, show_bar=show_bar_graph,
                                                          file_name=file_name,
