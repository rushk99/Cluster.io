...
clustering_method_one = StringDefinitionsHelper.DECONVOLUTION_LABEL
clustering_details_one = {"m_val": "3", "max_iter": "1500", "limit": "0.000001", "label": "Hardness"}
...
# clustering_method_one = StringDefinitionsHelper.K_MEANS_LABEL
# clustering_details_one = {"num_clusters": "3", "random_state": "0"}
clustering_method_two = StringDefinitionsHelper.K_MEANS_LABEL
clustering_details_two = {"num_clusters": "3", "random_state": "0"}
...
async def main_func():
    ...
    await RandIndex.execute(clustering_method_one=clustering_method_one, clustering_details_one=clustering_details_one,
                            clustering_method_two=clustering_method_two, clustering_details_two=clustering_details_two,
