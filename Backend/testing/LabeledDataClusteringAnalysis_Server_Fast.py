...
from helpers import StringDefinitionsHelper, LabeledDataClusteringAnalysisServer

# The cluster values to check for all plots
CLUSTER_VALUES = (1, 2, 3, 4, 5, 6, 10, 20)
...
CLUSTER_VALUES_SPECTRAL = (2, 3, 4, 5, 6, 7)
...
file_name = "../data/MTS_example1_25x25_flower_edited.xlsx"  # 10000
...
clustering_details_list_small = [
    ...
    {"num_clusters": "2", "random_state": "60"},
...
additional_outlier_clusters = True


async def main_func():
    # print(file_name, file_format)
    async def run_with_data(clustering_methods_list, clustering_details_list, cluster_names_list):
        await LabeledDataClusteringAnalysisServer.execute(clustering_methods_list=clustering_methods_list,
